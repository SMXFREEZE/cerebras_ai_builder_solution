...
`demo:loom` generates a Windows System.Speech voiceover from `scripts/loom-voiceover.txt`, then renders a 3-5 minute challenge-compliant walkthrough covering what was built, one tradeoff, and one microcopy call.
